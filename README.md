...
</html>import { GoogleGenAI, Type } from "@google/genai";
...
.markdown-body code { @apply font-mono bg-zinc-900 px-1 rounded text-emerald-400; }import tailwindcss from '@tailwindcss/vite';
